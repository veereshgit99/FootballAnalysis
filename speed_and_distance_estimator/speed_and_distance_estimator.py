            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, _ in object_tracks[frame_num].items():
                    ...
                    for frame_num_batch in range(frame_num, last_frame):
                        ...
                        tracks[object][frame_num_batch][track_id]["distance_covered"] = total_distance_covered[object][track_id]
            ...
            for object, object_tracks in tracks.items():
                ...
                for _, track_info in object_tracks[frame_num].items():
                    if "speed" in track_info:
                        ...
                        distance = track_info.get("distance_covered", None)
                        ...
                        cv2.putText(frame, f"Distance: {distance:.2f} m", (position[0], position[1] + 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
