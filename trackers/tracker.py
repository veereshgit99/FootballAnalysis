...
import supervision as sv # Used for tracking
import pickle 
import os
import sys
import cv2
...
class Tracker:
        ...
        for frame_num, detection in enumerate(detections):
            ...
            for frame_detection in detection_supervision:
                ...
                if cls_id == cls_names_inv["ball"]:
                    tracks["ball"][frame_num][1] = {"bbox": bbox} # Hard Coding track_id to 1, as there is only 1 ball in the frame
    ...
    def draw_ball_control(self, frame, frame_num, team_ball_control):
        # Draw a semi-transparent rectangle to display team ball control
